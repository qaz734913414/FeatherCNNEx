...
g++ -DX86_PC -g feather_convert_caffe.cc caffe.pb.cc ../src/common_utils.cpp ../src/aes.cpp -I/usr/include `pkg-config --cflags --libs protobuf` -o feather_convert_caffe -std=c++11 -I../src -I../src/crypto
